[![MCP Scorecard: 80/100](https://img.shields.io/badge/proofof.ai-80%2F100-5b21b6)](https://proofof.ai/scorecard/web-research-mcp.html)
...
mcp-name: io.github.CSOAI-ORG/web-research-mcp

# Web Research MCP Server

[![PyPI](https://img.shields.io/pypi/v/web-research-mcp)](https://pypi.org/project/web-research-mcp/) [![Python](https://img.shields.io/pypi/pyversions/web-research-mcp)](https://pypi.org/project/web-research-mcp/)
...
| **Docker** | `docker run -p 8000:8000 web-research-mcp` |
| **pip** | `pip install web-research-mcp` |
